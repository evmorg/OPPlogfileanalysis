...
***** Clusters for Normal Risk Pregnancy Episodes
...
save "`out_dir'/Clusters/cluster_norm.dta", replace

include project_paths.do
use "`out_dir'/Clusters/cluster_norm.dta", clear

cluster dendrogram clus_norm, cutnumber(15) 
graph export "`fig_dir'/clusters_dendogram_normpreg.pdf", as(pdf) replace

cluster stop, rule(duda)
cluster stop, rule(calinski)

cluster generate cluster = groups(3), name(clus_norm) ties(error)
...
export delimited "`out_dir'/sigtestR/cluster_norm.csv", replace
...
save "`out_dir'/Clusters/cluster_norm_tri1.dta", replace

include project_paths.do
use "`out_dir'/Clusters/cluster_norm_tri1.dta", clear

cluster dendrogram clus_norm_tri1, cutnumber(15) 
graph export "`fig_dir'/clusters_dendogram_normpreg_tri1.pdf", as(pdf) replace
...
export delimited "`out_dir'/sigtestR/cluster_norm_tri1.csv", replace
...
save "`out_dir'/Clusters/cluster_norm_tri2.dta", replace

include project_paths.do
use "`out_dir'/Clusters/cluster_norm_tri2.dta", clear

cluster dendrogram clus_norm_tri2, cutnumber(15) 
graph export "`fig_dir'/clusters_dendogram_normpreg_tri2.pdf", as(pdf) replace
...
export delimited "`out_dir'/sigtestR/cluster_norm_tri2.csv", replace
...
save "`out_dir'/Clusters/cluster_norm_tri3.dta", replace

include project_paths.do
use "`out_dir'/Clusters/cluster_norm_tri3.dta", clear

cluster dendrogram clus_norm_tri3, cutnumber(15) 
graph export "`fig_dir'/clusters_dendogram_normpreg_tri3.pdf", as(pdf) replace
...
export delimited "`out_dir'/sigtestR/cluster_norm_tri3.csv", replace
